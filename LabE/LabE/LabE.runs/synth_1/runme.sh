...
HD_PWD='C:/Users/salif/Documents/3C7 Labs/LabE/LabE/LabE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_ripple_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_ripple_adder.tcl
