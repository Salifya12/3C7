...
HD_PWD='C:/Users/salif/Documents/3C7 Labs/LabE/LabE/LabE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_ripple_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit_ripple_adder.tcl -notrace
